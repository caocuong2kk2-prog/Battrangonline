...
namespace BatTrang.API.Controllers.Admin
{
    ...
    public class AdminMaterialsController : ControllerBase
    {
        ...
        public AdminMaterialsController(AppDbContext context, IOutputCacheStore cacheStore)
        {
            _context = context;
        ...
        public async Task<IActionResult> BulkDelete([FromBody] BulkDeleteDto dto)
        {
            ...
            var entities = await _context.Materials.Where(x => dto.Ids.Contains(x.Id)).ToListAsync();
            if (entities.Any())
            {
