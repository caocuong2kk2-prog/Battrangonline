...
namespace BatTrang.Infrastructure.Migrations
{
    ...
    [Migration("20260606032606_AddAffiliateModule")]
    partial class AddAffiliateModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BatTrang.Core.Entities.AffiliateProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BatTrang.Core.Entities.AffiliateProfile", b =>
                {
                    b.HasOne("BatTrang.Core.Entities.Customer", "Customer")
                        ...
                        .HasForeignKey("BatTrang.Core.Entities.AffiliateProfile", "CustomerId")
            ...
            modelBuilder.Entity("BatTrang.Core.Entities.Commission", b =>
                {
                    b.HasOne("BatTrang.Core.Entities.Customer", "Affiliate")
                        .WithMany()
            ...
            modelBuilder.Entity("BatTrang.Core.Entities.Customer", b =>
                {
                    b.HasOne("BatTrang.Core.Entities.Customer", "Parent")
                        .WithMany("Children")
