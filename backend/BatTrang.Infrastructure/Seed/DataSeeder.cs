    ...
    public static class DataSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            if (!context.Products.Any())
            {
                ...
                {
                    new Product { Name = "Lộc Bình Vẽ Tay 1M6", Slug = "loc-binh-ve-tay-1m6", CategoryId = locBinh.Id, Material = "Gốm sứ cao cấp", Style = "Vẽ tay thủ công", Color = "Nâu – Vàng", Status = "active", Badge = "Nổi bật", Description = "Lộc bình vẽ tay 1M6 thuộc chất liệu gốm sứ cao cấp, qua tay nghệ nhân thủ công với hàng chục năm kinh nghiệm...", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-1-1.jpg", SortOrder = 1 }, new ProductImage { ImageUrl = "assets/images/product-1-2.jpg", SortOrder = 2 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "1.6m", Price = 40000000, Stock = 5 } } },
                    new Product { Name = "Lộc Bình Men Ra", Slug = "loc-binh-men-ra", CategoryId = locBinh.Id, Material = "Gốm sứ", Style = "Men ra", Color = "Xanh lam", Status = "active", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-2-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "1.2m", Price = 33000000, Stock = 8 } } },
                    new Product { Name = "Lộc Bình Trổ", Slug = "loc-binh-tro", CategoryId = locBinh.Id, Material = "Gốm sứ", Style = "Điêu khắc trổ", Color = "Trắng ngà", Status = "active", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-3-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "1.0m", Price = 26000000, Stock = 3 } } },
                    new Product { Name = "Tranh Gốm Phúc Lộc Thọ", Slug = "tranh-gom-phuc-loc-tho", CategoryId = tranhGom.Id, Material = "Gốm sứ", Style = "Vẽ tay", Color = "Đa sắc", Status = "active", Badge = "Mới", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-4-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "60x90cm", Price = 22808000, Stock = 12 } } },
                    new Product { Name = "Bộ Đồ Thờ Cao Cấp", Slug = "bo-do-tho-cao-cap", CategoryId = doTho.Id, Material = "Gốm sứ cao cấp", Style = "Truyền thống", Color = "Đỏ – Vàng", Status = "active", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-5-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "Bộ 5 món", Price = 15000000, Stock = 7 } } },
                    new Product { Name = "Bình Hút Lộc", Slug = "binh-hut-loc", CategoryId = binhHoa.Id, Material = "Gốm sứ", Style = "Vẽ tay", Color = "Trắng – Xanh", Status = "active", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-6-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "60cm", Price = 12000000, Stock = 15 } } },
                    new Product { Name = "Chum Ngâm Rượu", Slug = "chum-ngam-ruou", CategoryId = chumVat.Id, Material = "Gốm sứ dân gian", Style = "Truyền thống", Color = "Nâu tự nhiên", Status = "active", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-7-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "20 lít", Price = 9500000, Stock = 6 } } },
                    new Product { Name = "Đĩa Gốm Phong Thuỷ", Slug = "dia-gom-phong-thuy", CategoryId = diaGom.Id, Material = "Gốm sứ", Style = "Vẽ tay", Color = "Xanh – Trắng", Status = "active", Images = new List<ProductImage> { new ProductImage { ImageUrl = "assets/images/product-8-1.jpg", SortOrder = 1 } }, Variants = new List<ProductVariant> { new ProductVariant { Size = "40cm", Price = 8000000, Stock = 10 } } }
                };
